...
import dev.abhishekagrahari.mywishlistapp.data.DummyWish
import dev.abhishekagrahari.mywishlistapp.data.DummyWish.wishList
...
items(wishlist.value){
 ...
 SwipeToDismiss(state = dismissState, background = {
  val color by animateColorAsState(
   if(dismissState.dismissDirection == DismissDirection.EndToStart) Color.Red else Color.Blue
 ,label = ""
  )
